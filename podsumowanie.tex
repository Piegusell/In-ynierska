...
\noindent i pamiętając, że $\beta=\sum_{i=1}^{j}\beta_i$ można wciągnąć $\beta$ pod sumę we wzorze (\ref{rrrrrrrrrrryyyy}) i po uporządkowaniu ostatecznie dostać \textbf{wzór odwrotnych godzin}:
...
\noindent Jeżeli wprowadzaną reaktyność chcemy wyrazić w jednostkach $\$$, to, należy pamiętać, że $\rho_{\$}=\frac{\rho}{\beta}$, więc wtedy wzór odwrotnych godzin przyjmie postać:
